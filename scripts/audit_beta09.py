#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 09 update."""
...
from build_beta09 import FOLDER
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test09-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 09".encode("utf-16le")
    ...
    report = {
        "kind": "test-09-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test09/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 09", "marker_occurrences": app.count(marker),
        ...
        "tests": {"node_passed": 33, "python_passed": 193, "failed": 0},
