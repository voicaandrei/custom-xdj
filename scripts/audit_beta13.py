#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 13 update."""
...
from build_beta13 import FOLDER, PATCHES, COPY_OFFSET, COPY_BEFORE, KEY_ENTRY_OFFSET, KEY_ENTRY_BEFORE
...
from index_beta13_contract import inspect as inspect_beta13
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test13-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 13".encode("utf-16le")
    ...
    assert manifest['info_band']['surface_width']==292
    assert manifest['info_band']['width']==290
    ...
    report = {
        "kind": "test-13-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test13/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 13", "marker_occurrences": app.count(marker),
        ...
        "tests": json.loads((ROOT/"evidence/test13-validation.json").read_text()),
