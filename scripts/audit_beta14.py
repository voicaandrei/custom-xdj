#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 14 update."""
...
from build_beta14 import FOLDER, PATCHES, COPY_OFFSET, COPY_BEFORE, KEY_ENTRY_OFFSET, KEY_ENTRY_BEFORE
...
from index_beta14_contract import inspect as inspect_beta14
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test14-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 14".encode("utf-16le")
    ...
    report = {
        "kind": "test-14-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test14/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 14", "marker_occurrences": app.count(marker),
        ...
        "tests": json.loads((ROOT/"evidence/test14-validation.json").read_text()),
