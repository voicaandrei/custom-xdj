#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 15 update."""
...
from build_beta15 import FOLDER, PATCHES, COPY_OFFSET, COPY_BEFORE, KEY_ENTRY_OFFSET, KEY_ENTRY_BEFORE, ENTRY_PATCHES
...
from index_beta15_contract import inspect as inspect_beta15
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test15-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 15".encode("utf-16le")
    ...
    report = {
        "kind": "test-15-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test15/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 15", "marker_occurrences": app.count(marker),
        ...
        "tests": json.loads((ROOT/"evidence/test15-validation.json").read_text()),
