#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 11 update."""
...
from build_beta11 import FOLDER, PATCHES, COPY_OFFSET, COPY_BEFORE, KEY_ENTRY_OFFSET, KEY_ENTRY_BEFORE
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test11-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 11".encode("utf-16le")
    ...
    report = {
        "kind": "test-11-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test11/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 11", "marker_occurrences": app.count(marker),
        ...
        "tests": json.loads((ROOT/"evidence/test11-validation.json").read_text()),
