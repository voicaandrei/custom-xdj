#!/usr/bin/env python3
"""Independent bounded audit of the exact v1.44 Test 10 update."""
...
from build_beta10 import FOLDER
...
OUTPUT = ROOT / "evidence/browser-waveform-beta-v144-test10-final-audit.json"
...
def audit():
    ...
    marker = "XDJ BETA 10".encode("utf-16le")
    ...
    report = {
        "kind": "test-10-final-independent-container-audit",
        "date": "2026-09-09",
        "candidate": "private/browser-waveform-beta-v144-test10/XDJ1KMK2.UPD",
        ...
        "marker": "XDJ BETA 10", "marker_occurrences": app.count(marker),
        ...
        "fallback": "stock artwork without debug strip",
        ...
        "tests": {"node_passed": 33, "python_passed": 212, "failed": 0},
