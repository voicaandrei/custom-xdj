...
- Local documentation links checked. [GitHub CI passed on Ubuntu and macOS](https://github.com/voicaandrei/custom-xdj/actions/runs/34448108682): 384 Python tests discovered per runner, 85 passed and 299 explicitly skipped; 13 JavaScript tests passed and 3 skipped. These runners have no SH cross compiler. GNU symbol-output parsing and a host-fixture macro collision were corrected without changing the frozen player sources.
