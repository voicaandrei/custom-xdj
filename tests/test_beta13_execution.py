"""Run existing bounded wrapper cases against the actual Test 13 extension."""
import subprocess
import tempfile
from pathlib import Path
from tests import test_beta12_execution as previous
from build_beta13 import link_beta
from build_sh import toolchain

ROOT=Path(__file__).resolve().parents[1]

class Beta13Execution(previous.Beta12Execution):
    @classmethod
    def setUpClass(cls):
