/* Test 13: aligned allocation for the stock INFO surface is reused at 500,284, size 290x28.
...
#define WIDTH 290u
#define HEIGHT 28u
#define SURFACE_WIDTH 292u /* 584 bytes: compositor rounds pitch to 8 bytes. */

static void geometry(uint8_t *d)
{
    *(uint32_t *)(d + 4) = 500;
    *(uint32_t *)(d + 8) = 284;
    *(uint16_t *)(d + 12) = SURFACE_WIDTH;
    *(uint16_t *)(d + 14) = WIDTH;
